...
const Navbar = () => {
    ...
    return (
        ...
        <nav className="w-full px-8 py-4 border-b border-white/5 bg-zinc-900/20 backdrop-blur-md flex justify-between items-center">
                ...
                <button 
                    onClick={logout}
                    className="flex items-center gap-2 px-4 py-2 text-zinc-400 hover:text-red-400 hover:bg-red-400/10 rounded-lg transition-all text-sm font-medium border border-transparent hover:border-red-400/20"
                >
